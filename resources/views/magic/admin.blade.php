...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('static/vendors/font-awesome/css/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{ asset('static/vendors/themify-icons/css/themify-icons.css')}}">
    <link rel="stylesheet" href="{{ asset('static/vendors/flag-icon-css/css/flag-icon.min.css')}}">
    <link rel="stylesheet" href="{{ asset('static/vendors/selectFX/css/cs-skin-elastic.css')}}">
    <link rel="stylesheet" href="{{ asset('static/vendors/jqvmap/dist/jqvmap.min.css')}}">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-user"></i><a href="{{route('admin.manage')}}">Admin</a></li>
                            <li><i class="fa fa-user"></i><a href="{{ route('admin.users.index') }}">User</a></li>
...
<script src="{{ asset('static/vendors/jquery/dist/jquery.min.js')}}"></script>
    <script src="{{ asset('static/vendors/popper.js/dist/umd/popper.min.js')}}"></script>
    ...
    <script src="{{ asset('static/vendors/chart.js/dist/Chart.bundle.min.js')}}"></script>
    <script src="{{ asset('static/assets/js/dashboard.js')}}"></script>
    <script src="{{ asset('static/assets/js/widgets.js')}}"></script>
    <script src="{{ asset('static/vendors/jqvmap/dist/jquery.vmap.min.js')}}"></script>
