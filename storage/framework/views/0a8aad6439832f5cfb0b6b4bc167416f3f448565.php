        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-md-6">
                <div style="background-color: #fff; border-radius: 10px; padding: 30px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
                    <h2 style="text-align: center; color: #c79787;">Admin Login</h2>
                    ...
                    <form action="<?php echo e(route('admin.login.store')); ?>" method="POST" style="margin-top: 20px;">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('magic.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/project/resources/views/admin/login.blade.php ENDPATH**/ ?>